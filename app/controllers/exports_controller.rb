class ExportsController < ApplicationController
  ...
  private
    ...
    def export_params
      params.require(:export).permit(:assigned_number, :pedimento_number, :export_type_id, :total, :iva, :notes, :export_date, exports_parts_attributes: %i[id quantity part_id imports_part_id export_date _destroy])
    end
end
